  ...
  <div class="dashboard">
    ...
    <div class="content">
      ...
      <div class="social" style="margin-top:20px; magin-bottom:20px;">
        ...
        <a
          href="https://twitter.com/intent/tweet?text=Help%20me%20fight%20climate%20change%20while%20shopping%20-%20easy%20and%20for%20free!%20http%3A%2F%2Fco2ok.ninja%2F152"
        >
      ...
      <div class="group">
        <div class="box-co2 group_col">
          ...
          <p
            style="text-decoration: underline; font-size: 20px; text-align: center; "
          >{{number}} KGS</p>
          <div class="img_container">
            <img src="../../../assets/chimneys-co2-compensated.png">
          </div>
          <p class="chimneys-text">
            (Our developers are working hard to make
            <br>the CO2 counter work in the near future)
          </p>
        </div>
        <div class="box-stars">
      ...
      <p style="text-align: center;">
        The online shop makes your purchase climate neutral and that way we actively compensate CO2 through a sustainable project.
        <br>Make sure every penny is worth it so we can live on a green and clean planet.
      </p>
      <div class="pick group_col">
        ...
        <div class="img_container_ninja" style="margin:10px;">
          <div class="block">
            <img
              src="../../../assets/cropped-cropped-klimaschutzprojekt-indien-square.jpg"
              style="height:150px; width: 150px; border-radius: 15px; box-shadow: 2px 2px 20px grey;"
            >
          </div>
          <div class="block">
            <img
              src="../../../assets/cropped-cropped-zon-en-wind-winter-square.jpg"
              style="height:150px; width: 150px; border-radius: 15px; box-shadow: 2px 2px 20px grey;"
            >
          </div>
          <div class="block">
            <img
              src="../../../assets/Save80cookingstove-square.jpg"
              style="height:150px; width: 150px; border-radius: 15px; box-shadow: 2px 2px 20px grey;"
            >
          </div>
        </div>
