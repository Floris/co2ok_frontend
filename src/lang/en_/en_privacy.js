module.exports = {
  p: `
    <p>We fight climate change,
    we don’ t mine data!That is why we don’ t collect or save any of your personal shopping data.With us your data is yours only.</p>

    <p>We work transparent and our code is open source.You can have a look how our Ninja App is technically made.The entire source code is open
    for you,
    no secrets involved.You find it here: <a href="https://github.com/Mil0dV/co2ok-ninja" target="_blank">Sourcecode Ninja App - browserextension</a></p>

    <p>Your Ninja App system only needs the right to locally see which online shop you are visiting to activate the commission.The information about visited websites does not leave your computer,
    so your privacy is protected.</p>
  `,
  questions: {
    q1: {
      ...
      a: `
          ...
          <p>We may also collect information how the Service 
          is accessed and used (“Usage Data”). This Usage Data may include information 
    ...
    q2: {
      q: `Use of Data`,
      a: `<p>CO₂ok uses the collected data for various purposes:</p>
    ...
    q3: {
      ...
      <p>If you are located outside Netherlands and choose to provide information to us, 
      please note that we transfer the data, including Personal Data, to Netherlands and process it there.</p>
      
      <p>Your consent to this Privacy Policy followed by your submission of such information represents your agreement 
      to that transfer.</p>
      
      <p>CO₂ok will take all steps reasonably necessary to ensure that your data is treated securely and in accordance 
    ...
    q4: {
      ...
      <p>CO₂ok may disclose your Personal Data in the good faith belief that such action is necessary to:<p>
  
      <p>•  To comply with a legal obligation<br>
      •  To protect and defend the rights or property of CO₂ok<br>
    ...
    q6: {
      ...
      <p>•   Google Analytics is a web analytics service offered by Google that tracks and reports  
       website traffic. Google uses the data &nbsp&nbsp&nbspcollected to track and monitor the use of our  
       Service. This data is shared with other Google services. Google may use the     
       &nbsp&nbsp&nbspcollected data to contextualize and personalize the ads of its own advertising   
       network.</p>
